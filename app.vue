...
useSeoMeta({
  ...
  charset: "UTF-8",
  title: "國立臺北大學資訊工程學系",
  ogTitle: "國立臺北大學資訊工程學系",
  description:
    "這是一個臨時的跳轉網站，用於重定向到國立臺北大學資訊工程學系的真正官網。請稍等，我們會自動將您帶到最新的系所資訊、課程介紹、師資陣容及研究成果。",
  ogDescription:
    "這是一個臨時的跳轉網站，用於重定向到國立臺北大學資訊工程學系的真正官網。請稍等，我們會自動將您帶到最新的系所資訊、課程介紹、師資陣容及研究成果。",
  ogType: "website",
  ogUrl: baseUrl,
  ogImage: `${baseUrl}/logo-sm.png`,
  ...
  twitterDescription:
    "這是一個臨時的跳轉網站，用於重定向到國立臺北大學資訊工程學系的真正官網。請稍等，我們會自動將您帶到最新的系所資訊、課程介紹、師資陣容及研究成果。",
  twitterImage: `${baseUrl}/logo-sm.png`,
